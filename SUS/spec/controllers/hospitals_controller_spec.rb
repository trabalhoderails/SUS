  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved hospital as @hospital" do
        ...
        allow_any_instance_of(Hospital).to receive(:save).and_return(false)
        post :create, {:hospital => { "nome" => "invalid value" }}, valid_session
        expect(assigns(:hospital)).to be_a_new(Hospital)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested hospital" do
        ...
        expect_any_instance_of(Hospital).to receive(:update).with({ "nome" => "MyString" })
        put :update, {:id => hospital.to_param, :hospital => { "nome" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the hospital as @hospital" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Hospital).to receive(:save).and_return(false)
        put :update, {:id => hospital.to_param, :hospital => { "nome" => "invalid value" }}, valid_session
        expect(assigns(:hospital)).to eq(hospital)
      end
